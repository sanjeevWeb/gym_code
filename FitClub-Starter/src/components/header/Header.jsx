  ...
  return (
    <div>
      <div className="header">
        ...
        {(menuOpened === false && mobile === true) ? (<div style={{backgroundColor:'var(--appColor)',
        padding: '0.5rem',borderRadius:'5px'}} onClick={() => setMenuOpened(true)}><img src={Bars} alt="img" style={{width:'1.5rem',height:'1.5rem'}} /></div>) :
